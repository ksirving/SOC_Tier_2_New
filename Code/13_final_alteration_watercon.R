...
write.csv(suit_data2_50, file = "output_data/13_Level2_altered_metrics_results_50pcttimealtered_0.92csci_prob25_0.94asci_prob50_WaterCon.csv")
...
file.name <- "output_data/13_summary.50pct.time.altered.2metrics.WaterCon.csv"
...
# write plot
out.filename <- "output_data/Manuscript/Figures/Maps/13_Synthesis_Prioritization_map_LSPC_all_Aliso_Oso_small_creeks_SJ_WaterCon.jpg"
...
for(z in indices){
  ...
  # write plot
  out.filename <- paste0("output_data/Manuscript/Figures/Maps/13_", z, "_alteration_map_LSPC_Aliso_Oso_small_creeks_SJ_WaterCon.jpg")
...
file.name.summary <- "output_data/13_SOC_CSCI_ASCI_HydroAlt_Synthesis_Summary_WaterCon.csv"
